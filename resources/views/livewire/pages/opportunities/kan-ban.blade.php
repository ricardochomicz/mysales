<div>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="form-group col-sm-4 has-search">
                    <input wire:model.live="search" class="form-control" name="search" placeholder="pesquisa por nome...">
                </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-2">
                    <x-input type="date" wire:model.live.debounce.500ms="dt_end" class="tooltips"
                        data-text="Data Fim" />
                </div>
                    ...
                    @foreach ($data->filter(fn($item) => $item->funnel == 'prospect') as $item)
                        <div class="card card-primary card-outline" data-id="{{ $item->id }}">
                            ...
                            <div class="card-body p-2">
                                <small><i class="fas fa-thermometer-half"></i> <b>{{ $item->probability }}%</b> -
                                    {{ $item->ordem->name }} - {{ $item->operadora->name }}</small><br>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <a href="javascript:void(0)"
                                            wire:click="loadCommentsKanban({{ $item->id }})" data-toggle="modal"
                                            data-target="#modalCommentsKanban" class="btn btn-success btn-sm tooltips"
    ...
    <div class="modal fade" id="modalCommentsKanban" aria-labelledby="exampleModalLabel" aria-hidden="true"
        wire:ignore.self>
