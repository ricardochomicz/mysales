            ...
            <div class="small-box shadow-none">
                ...
                <div class="table-responsive rounded">
                    ...
                    <table class="table table-borderless table-hover">
                        <caption><small>Tags cadastradas <b>{{$data->count()}}</b></small></caption>
                                ...
                                <td class="text-center">
                                    @if($d->edit)
                                        @if($d->deleted_at === null)
                                            <a href="{{route('tags.edit', $d->id)}}"
                                               class="btn btn-primary btn-sm tooltips" data-text="Editar">
                                                <i class="fas fa-sync-alt"></i>
                                            </a>

                                            <a href="javascript:void(0)"
                                               onclick="ativaDesativa('{{route('tags.destroy',  $d->id)}}', 'desativar', '{{$d->label}}')"
                                        ...
                                        @else
                                            <a href="javascript:void(0)"
                                               onclick="ativaDesativa('{{route('tags.destroy',  $d->id)}}', 'ativar', '{{$d->label}}')"
