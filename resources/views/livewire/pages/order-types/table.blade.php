            ...
            <div class="small-box shadow-none">
                ...
                <div class="table-responsive rounded">
                    ...
                    <table class="table table-borderless table-hover">
                        <caption><small>Tipo Pedidos cadastrados <b>{{$data->count()}}</b></small></caption>
                                ...
                                <td class="text-center">
                                    @if($d->deleted_at === null)
                                        ...
                                        <a href="javascript:void(0)"
                                           onclick="ativaDesativa('{{route('order-types.destroy',  $d->id)}}', 'desativar', '{{$d->label}}')"
                                    ...
                                    @else
                                        <a href="javascript:void(0)"
                                           onclick="ativaDesativa('{{route('order-types.destroy',  $d->id)}}', 'ativar', '{{$d->label}}')"
