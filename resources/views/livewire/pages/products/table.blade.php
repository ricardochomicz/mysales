            ...
            <div class="small-box shadow-none">
                ...
                <div class="table-responsive rounded">
                    ...
                    <table class="table table-borderless table-hover">
                        <caption><small>Produtos cadastrados <b>{{ $data->total() }}</b></small></caption>
                        ...
                        <tbody>
                            @foreach ($data as $d)
                                <tr class="{{ $d->visible ? '' : 'text-danger' }}">
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        @if ($d->deleted_at === null)
                                            <a href="javascript:void(0)" wire:click="visible({{ $d->id }})"
                                                class="btn btn-secondary btn-sm tooltips" data-text="Ativo">
                                                <i class="fas {{ $d->visible ? 'fa-eye' : 'fa-eye-slash' }}"></i>
                                            </a>
