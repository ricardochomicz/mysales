            ...
            <div class="small-box shadow-none">
                ...
                <div class="table-responsive rounded">
                    ...
                    <table class="table table-borderless table-hover">
                        <caption><small>Categorias cadastradas <b>{{$data->total()}}</b></small></caption>
                        ...
                        @foreach($data as $d)
                            <tr>
                                ...
                                <td class="text-center">
                                    @if($d->deleted_at === null)
                                        ...
                                        @can('manage-categories')
                                            <a href="javascript:void(0)"
                                               onclick="ativaDesativa('{{route('categories.destroy',  $d->id)}}', 'desativar', '{{$d->label}}')"
                                    ...
                                    @else
                                        <a href="javascript:void(0)"
                                           onclick="ativaDesativa('{{route('categories.destroy',  $d->id)}}', 'ativar', '{{$d->label}}')"
