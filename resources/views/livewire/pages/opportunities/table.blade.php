<div>
                            ...
                            @foreach ($data as $d)
                                <tr>
                                    ...
                                    <td class="text-center">R$
                                        {{ number_format($d->total, 2, ',', '.') }}<br>{{ $d->qty }}
                                    </td>
                                    <td class="text-center">
                                        @switch($d->funnel)
                                            @case('prospect')
                                        ...
                                        @endswitch
                                        <br>
                                        <small class="text-blue tooltips"
                                            data-text="Probabilidade">{{ $d->probability }}
                                            %</small>
                                    </td>
    ...
    <div class="modal fade" id="modalComments" aria-labelledby="exampleModalLabel" aria-hidden="true"
        wire:ignore.self>
...
@push('scripts')
    ...
    <script>
        ...
        Livewire.on('resetSelectpicker', function() {
            $("#sel1, #sel2, #sel3, #sel4").selectpicker('val',
                '') // Ou qualquer outra lógica de redefinição necessária
        });
    </script>
@endpush
